...
class ColumnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create column" do
    assert_difference('Column.count') do
      post columns_url, params: { column: { BatteryId: @column.BatteryId, Information: @column.Information, Nombre: @column.Nombre, Notes: @column.Notes, Statut: @column.Statut, Type: @column.Type } }
    end
  ...
  test "should update column" do
    patch column_url(@column), params: { column: { BatteryId: @column.BatteryId, Information: @column.Information, Nombre: @column.Nombre, Notes: @column.Notes, Statut: @column.Statut, Type: @column.Type } }
